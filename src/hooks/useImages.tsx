...
export function ImageProvider({ children }: ImageProviderProps) {
    ...
    useEffect(() => {
        ...
        api.get<GetProps>(`Curiosity/photos?earth_date=${search.earth_date}&api_key=icP0cCqSybcLhGaw9s0kz7BALeaCF2kW7P1p7cdQ`)
        ...
        api.get<GetProps>(`Opportunity/photos?earth_date=${search.earth_date}&api_key=icP0cCqSybcLhGaw9s0kz7BALeaCF2kW7P1p7cdQ`)
        ...
        api.get<GetProps>(`Spirit/photos?earth_date=${search.earth_date}&api_key=icP0cCqSybcLhGaw9s0kz7BALeaCF2kW7P1p7cdQ`)
